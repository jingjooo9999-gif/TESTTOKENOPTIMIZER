...
function appendRequestRow(record, prepend = true) {
  ...
  const statusText = record.cached
    ? `<span class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-medium ${badgeClass}"><i data-lucide="zap" class="w-3 h-3"></i> Cached (0ms)</span>`
    : `<span class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-medium ${badgeClass}"><i data-lucide="check" class="w-3 h-3"></i> Optimized</span>`;
